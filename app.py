...
if __name__ == '__main__':
    app.run(host='0.0.0.0', p# -*- coding: utf-8 -*-
import os
import json
import time
import base64
...
# 初始化 Google Gemini AI 客戶端（會自動讀取環境變數中的 GEMINI_API_KEY）
...
def handle_message(event):
    ...
    if "你好！我要找客服" in user_text:
        ...
        # 如果不是在填寫資料的流程中，就交給 Google Gemini AI 智慧回答！
        try:
            prompt = (
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5000, debug=True)ort=5000, debug=True)